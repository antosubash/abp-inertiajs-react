...
public class InertiaDemoTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<InertiaDemoTenantDatabaseMigrationHandler> _logger;

    public InertiaDemoTenantDatabaseMigrationHandler(
        InertiaDemoDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<InertiaDemoTenantDatabaseMigrationHandler> logger)
    {
